...
func (tx *Transaction) GetTime() time.Time { return tx.time }
func (tx *Transaction) IsEncrypt() bool { return tx.data.Recipient != nil }
...
func (m Message) SetTo(toAddr *common.Address)  { m.to = toAddr }
